...
Current active computation: local CPU Diamonds seed 3 begins with the same
pinned source data and full-scale runner. A detached serial watchdog will run
seeds 4--9 one at a time using that exact command; it does not permit CPU
