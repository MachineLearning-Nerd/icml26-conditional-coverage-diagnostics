...
The attempted code is retained in the [MNIST](https://github.com/MachineLearning-Nerd/icml26-repro-vaApZm6MKM-conditional-coverage-diagnostics/tree/orx/claim-5-table-4-classification-on-mnist), [FashionMNIST](https://github.com/MachineLearning-Nerd/icml26-repro-vaApZm6MKM-conditional-coverage-diagnostics/tree/orx/claim-5-table-4-classification-on-fashionmnist), and [CIFAR10](https://github.com/MachineLearning-Nerd/icml26-repro-vaApZm6MKM-conditional-coverage-diagnostics/tree/orx/claim-5-table-4-classification-on-cifar10) branches. The official experiment code remains pinned to `ElSacho/Conditional_Coverage_Estimation@39a99dcad92205a15d93f2c5fec40c76540abf1c` and the metric implementation to `ElSacho/covmetrics@a5205aada6a0f39e3812daf087753217ef66b159`.
